...
const PrivacyPolicy = () => {
    return (
        <div className='py-[20vw] px-[30px] md:py-[5vw] md:pt-[15vw] xl:px-[193px] lg:px-[113px] md:px-[20px] text-white leading-[25px]'>
            <h1 className='text-[#FFE8BA] pb-[50px] text-center'>Privacy Policy</h1>
            <p className='text-center pb-[15px]'>Last updated: December 18, 2023</p>
            ...
            <h2 className=' text-center text-[#FFE8BA] py-[50px] text-center'>Interpretation and Definitions</h2>
            <h4 className='text-[#FFE8BA] pb-[20px]'>Interpretation</h4>
            <p>
                The words of which the initial letter is capitalized have meanings defined
                under the following conditions. The following definitions shall have the
                same meaning regardless of whether they appear in singular or in plural.
            </p>
            <h4 className='text-[#FFE8BA] py-[20px] pt-[50px]'>Definitions</h4>
            <p className='pb-[20px]'>For the purposes of this Privacy Policy:</p>
            <ul className='flex flex-col gap-[20px]'>
                ...
                <li>
                    <p>
                        <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Vedic Sadhana Technologies,
                        Post Kargannu via Oochghat Distt.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Sadhana Tablet, accessible from&quot;
                        <a
                            href="http://sadhanatablet.com"
                            rel="external nofollow noopener"
                            target="_blank"
                        >
                            http://sadhanatablet.com
                        </a>
                    </p>
                </li>
                <li>
            ...
            <h2 className=' text-center text-[#FFE8BA] py-[50px] text-center'>Collecting and Using Your Personal Data</h2>
            <h4 className='text-[#FFE8BA] py-[15px]'>Types of Data Collected</h4>
            <h4 className='text-[#FFE8BA] py-[20px]'>Personal Data</h4>
            <p className='pb-[20px]'>
            ...
            <h4 className='text-[#FFE8BA] py-[20px]'>Usage Data</h4>
            <p className='pb-[20px]'>Usage Data is collected automatically when using the Service.</p>
            <p className='pb-[20px]'>
            ...
            <h4 className='text-[#FFE8BA] py-[20px]'>Tracking Technologies and Cookies</h4>
            <p className='pb-[20px]'>
            ...
            <h4 className='text-[#FFE8BA] py-[20px]'>Use of Your Personal Data</h4>
            <p className='pb-[20px]'>The Company may use Personal Data for the following purposes:</p>
            <ul className='flex flex-col gap-[20px]'>
                <li>
                    <p>
            ...
            <p className='pb-[20px]'>We may share Your personal information in the following situations:</p>
            <ul className='flex flex-col gap-[20px]'>
                <li>
            ...
            <h4 className='text-[#FFE8BA] py-[20px]'>Retention of Your Personal Data</h4>
            <p className='pb-[20px]'>
            ...
            <h4 className='text-[#FFE8BA] py-[20px]'>Transfer of Your Personal Data</h4>
            <p className='pb-[20px]'>
            ...
            <h4 className='text-[#FFE8BA] py-[20px]'>Delete Your Personal Data</h4>
            <p className='pb-[20px]'>
            ...
            <h4 className='text-[#FFE8BA] py-[20px]'>Disclosure of Your Personal Data</h4>
            <h4 className='text-[#FFE8BA] py-[20px]'>Business Transactions</h4>
            <p className='pb-[20px]'>
            ...
            <h4 className='text-[#FFE8BA] py-[20px]'>Law enforcement</h4>
            <p className='pb-[20px]'>
            ...
            <h4 className='text-[#FFE8BA] py-[20px]'>Other legal requirements</h4>
            <p className='pb-[20px]'>
            ...
            <h4 className='text-[#FFE8BA] py-[20px]'>Security of Your Personal Data</h4>
            <p className='pb-[20px]'>
            ...
            <h2 className=' text-center text-[#FFE8BA] py-[50px]'>Children&apos;s Privacy</h2>
            <p className='pb-[20px]'>
            ...
            <h2 className=' text-center text-[#FFE8BA] py-[50px] '>Links to Other Websites</h2>
            <p className='pb-[20px]'>
            ...
            <h2 className=' text-center text-[#FFE8BA] py-[50px]'>Changes to this Privacy Policy</h2>
            <p className='pb-[20px]'>
            ...
            <h2 className=' text-center text-[#FFE8BA] py-[50px]'>Contact Us</h2>
            <p className='pb-[20px]'>
