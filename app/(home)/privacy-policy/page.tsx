...
const PrivacyPolicy = () => {
    return (
        <div className='py-[20vw] md:py-[5vw] px-[20px] text-white'>
            <h1 className='text-[#FFE8BA] pb-[10px]'>Privacy Policy</h1>
            ...
            <h3 className='text-[#FFE8BA] pb-[10px]'>Interpretation</h3>
            <p>
                The words of which the initial letter is capitalized have meanings defined
                under the following conditions. The following definitions shall have the
                same meaning regardless of whether they appear in singular or in plural.
            </p>
            <h3 className='text-[#FFE8BA] py-[10px]'>Definitions</h3>
            ...
            <h2 className='text-[#FFE8BA] py-[10px]'>Collecting and Using Your Personal Data</h2>
            <h3 className='text-[#FFE8BA] py-[10px]'>Types of Data Collected</h3>
            <h4 className='text-[#FFE8BA] py-[10px]'>Personal Data</h4>
            <p>
            ...
            <h4 className='text-[#FFE8BA] py-[10px]'>Usage Data</h4>
            ...
            <h4 className='text-[#FFE8BA] py-[10px]'>Tracking Technologies and Cookies</h4>
            <p>
            ...
            <h3 className='text-[#FFE8BA] py-[10px]'>Use of Your Personal Data</h3>
            ...
            <h3 className='text-[#FFE8BA] py-[10px]'>Retention of Your Personal Data</h3>
            <p>
            ...
            <h3 className='text-[#FFE8BA] py-[10px]'>Transfer of Your Personal Data</h3>
            <p>
            ...
            <h3 className='text-[#FFE8BA] py-[10px]'>Delete Your Personal Data</h3>
            <p>
            ...
            <h3 className='text-[#FFE8BA] py-[10px]'>Disclosure of Your Personal Data</h3>
            <h4 className='text-[#FFE8BA] py-[10px]'>Business Transactions</h4>
            <p>
            ...
            <h4 className='text-[#FFE8BA] py-[10px]'>Law enforcement</h4>
            <p>
            ...
            <h4 className='text-[#FFE8BA] py-[10px]'>Other legal requirements</h4>
            <p>
            ...
            <h3 className='text-[#FFE8BA] py-[10px]'>Security of Your Personal Data</h3>
            <p>
            ...
            <h2 className='text-[#FFE8BA] py-[10px]'>Children&apos;s Privacy</h2>
            <p>
            ...
            <h2 className='text-[#FFE8BA] py-[10px] '>Links to Other Websites</h2>
            <p>
            ...
            <h2 className='text-[#FFE8BA] py-[10px]'>Changes to this Privacy Policy</h2>
            <p>
            ...
            <h2 className='text-[#FFE8BA] py-[10px]'>Contact Us</h2>
            <p>
