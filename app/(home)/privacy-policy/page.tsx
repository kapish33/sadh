...
const PrivacyPolicy = () => {
    return (
        <div className='py-[20vw] md:py-[5vw] px-[20px] text-white'>
            <h1 className='text-[#FFE8BA] pb-[15px]'>Privacy Policy</h1>
            ...
            <h2 className='text-[#FFE8BA] py-[15px]'>Interpretation and Definitions</h2>
            <h3 className='text-[#FFE8BA] pb-[20px]'>Interpretation</h3>
            <p>
                The words of which the initial letter is capitalized have meanings defined
                under the following conditions. The following definitions shall have the
                same meaning regardless of whether they appear in singular or in plural.
            </p>
            <h3 className='text-[#FFE8BA] py-[20px]'>Definitions</h3>
            ...
            <h2 className='text-[#FFE8BA] py-[15px]'>Collecting and Using Your Personal Data</h2>
            <h3 className='text-[#FFE8BA] py-[15px]'>Types of Data Collected</h3>
            ...
            <h3 className='text-[#FFE8BA] py-[20px]'>Use of Your Personal Data</h3>
            ...
            <h3 className='text-[#FFE8BA] py-[20px]'>Retention of Your Personal Data</h3>
            <p>
            ...
            <h3 className='text-[#FFE8BA] py-[20px]'>Transfer of Your Personal Data</h3>
            <p>
            ...
            <h3 className='text-[#FFE8BA] py-[20px]'>Delete Your Personal Data</h3>
            <p>
            ...
            <h3 className='text-[#FFE8BA] py-[20px]'>Disclosure of Your Personal Data</h3>
            ...
            <h3 className='text-[#FFE8BA] py-[20px]'>Security of Your Personal Data</h3>
            <p>
            ...
            <h2 className='text-[#FFE8BA] py-[20px]'>Children&apos;s Privacy</h2>
            <p>
            ...
            <h2 className='text-[#FFE8BA] py-[20px] '>Links to Other Websites</h2>
            <p>
            ...
            <h2 className='text-[#FFE8BA] py-[20px]'>Changes to this Privacy Policy</h2>
            <p>
            ...
            <h2 className='text-[#FFE8BA] py-[20px]'>Contact Us</h2>
            <p>
